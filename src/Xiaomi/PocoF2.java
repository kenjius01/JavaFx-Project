...
public class PocoF2 implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        File brandFile = new File("res/xiaomi/xiaomiSymbol.gif");
        Image brandImg = new Image(brandFile.toURI().toString());
        brandImgView.setImage(brandImg);

        String path = new File
                ("res/xiaomi/POCO F2 Pro Introduction Features Official Video HD - Pocophone F2 Pro 5G Unboxing.mp4").getAbsolutePath();
    ...
    public void back() {
        mp.pause();
        HomePageController.getInstance().createPage(holderpane, "Xiaomi.fxml");
    }
}
