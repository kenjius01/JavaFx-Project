...
public class VivoX60 implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        String path = new File
                ("res/vivo/vivo X60 Pro+ - The new era of smartphones - Pre-book now for a #PhotographyRedefined Xperience.mp4").getAbsolutePath();
