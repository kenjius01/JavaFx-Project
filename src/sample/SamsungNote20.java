...
public class SamsungNote20 implements Initializable {
    @FXML
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        File brandFile = new File("res/Samsung/samsungBrand.gif");
        Image brandImg = new Image(brandFile.toURI().toString());
        brandImgView.setImage(brandImg);

        String path = new File
                ("res/Samsung/Galaxy Note20 Ultra- Official Unboxing - Samsung.mp4").getAbsolutePath();
    ...
    public void back() {
        mp.pause();
        HomePageController.getInstance().createPage(holderpane, "Samsung.fxml");
    }
}
